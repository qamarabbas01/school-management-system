<script>
        ...
        students = [
          ...
          },
          {
            ...
            results: [
              ...
              { examId: 2, marks: 38, grade: "C", remarks: "Needs improvement in theory" }
            ]
          },
          {
            id: 3,
            ...
            rollNumber: "A003",
            results: [
              { examId: 1, marks: 95, grade: "A+", remarks: "Outstanding performance" },
              { examId: 2, marks: 48, grade: "A", remarks: "Excellent grasp of concepts" }
            ]
          },
          {
            id: 4,
            ...
            rollNumber: "A004",
            results: [
              { examId: 1, marks: 35, grade: "F", remarks: "Needs significant improvement" },
          ...
          },
          {
            ...
            results: [
              ...
              { examId: 2, marks: 45, grade: "A", remarks: "Excellent understanding" }
            ]
          },
          {
            id: 6,
            ...
            rollNumber: "A006",
            results: [
              { examId: 1, marks: 65, grade: "C+", remarks: "Average performance" },
              { examId: 2, marks: 30, grade: "C", remarks: "Needs to focus more" }
            ]
          },
          {
            id: 7,
            ...
            results: [
              ...
              { examId: 2, marks: 47, grade: "A", remarks: "Very good understanding" }
            ]
          },
          {
            id: 8,
            ...
            results: [
              ...
              { examId: 2, marks: 28, grade: "D", remarks: "Struggling with concepts" }
            ]
          },
          {
            id: 9,
            ...
            results: [
              ...
              { examId: 2, marks: 44, grade: "B+", remarks: "Good understanding" }
            ]
          },
          {
            id: 10,
          ...
          },
          {
            ...
            rollNumber: "A011",
            results: [
              { examId: 1, marks: 62, grade: "C+", remarks: "Average performance" },
              { examId: 2, marks: 32, grade: "C", remarks: "Needs more practice" }
            ]
          },
          {
            id: 12,
            ...
            results: [
              ...
              { examId: 2, marks: 46, grade: "A", remarks: "Excellent understanding" }
            ]
          }
        ];
      }
    ...
    function calculatePassPercentage(examId) {
      ...
      const passedCount = results.filter(result => result.marks >= exam.passingMarks).length;
  ...
  <div class="exam-container">
      ...
      <div class="exams-list" transition:fade={{ duration: 200 }}>
        {#if sortedExams.length === 0}
          <div class="no-results">
            <p>No exams found. {canManage ? 'Click "New Exam" to add one.' : ''}</p>
          </div>
        {:else}
                ...
                <div class="exam-stats">
                  {#if getExamStats(exam.id)}
                    <div class="stats-grid">
                      <div class="stat-item">
                        <span class="stat-value">{getExamStats(exam.id)?.average || '-'}</span>
                        <span class="stat-label">Average</span>
                      </div>
                      <div class="stat-item">
                        <span class="stat-value">{getExamStats(exam.id)?.passPercentage || '-'}%</span>
                        <span class="stat-label">Pass Rate</span>
                      </div>
                      <div class="stat-item">
                        <span class="stat-value">{getExamStats(exam.id)?.highest}</span>
                        <span class="stat-label">Highest</span>
                      </div>
                      <div class="stat-item">
                        <span class="stat-value">{getExamStats(exam.id)?.lowest}</span>
        ...
        <div class="exam-selector">
          ...
          <div class="exam-pills">
            {#each exams.filter(e => e.status === 'completed') as exam (exam.id)}
              <button 
                class="exam-pill {selectedExam && selectedExam.id === exam.id ? 'active' : ''}"
              ...
              <table class="results-table">
                ...
                <tbody>
                  {#each filteredStudents as student (student.id)}
                    ...
                    <tr class={result ? (result.marks >= selectedExam.passingMarks ? 'pass' : 'fail') : ''}>
                      <td>{student.rollNumber}</td>
                      <td class="student-cell">
                        <img src={student.avatar || "/placeholder.svg"} alt={student.name} class="student-avatar-small" />
                        <span>{student.name}</span>
                      </td>
                      <td>{result ? result.marks : '-'}/{selectedExam.totalMarks}</td>
                      <td>
                        {#if result}
                      ...
                      <td>
                        {#if result}
                          <span class="status-pill {result.marks >= selectedExam.passingMarks ? 'pass' : 'fail'}">
                            {result.marks >= selectedExam.passingMarks ? 'Pass' : 'Fail'}
                          </span>
                        {:else}
      ...
      <div class="modal-backdrop" transition:fade>
        <div class="modal" transition:slide={{ duration: 300 }}>
          ...
          <div class="modal-actions">
            <button class="cancel-btn" on:click={() => showAddExamModal = false}>Cancel</button>
            <button 
              class="save-btn" 
              on:click={saveExam}
    ...
    {#if showStartExamModal}
      <div class="modal-backdrop" transition:fade>
        <div class="modal" transition:slide={{ duration: 300 }}>
          ...
          {#if selectedExam}
            <p>Are you sure you want to start the exam <strong>{selectedExam.name}</strong>?</p>
            <p>This will mark the exam as ongoing and allow students to take it.</p>
            ...
            <div class="exam-details-summary">
              ...
              <div class="detail-item">
                <span class="detail-label">Time:</span>
                <span class="detail-value">{selectedExam.startTime} - {selectedExam.endTime}</span>
              </div>
              <div class="detail-item">
                <span class="detail-label">Duration:</span>
          ...
          <div class="modal-actions">
            <button class="cancel-btn" on:click={() => showStartExamModal = false}>Cancel</button>
            <button class="confirm-btn" on:click={confirmStartExam}>Start Exam</button>
          </div>
        </div>
      </div>
    {/if}
    ...
    {#if showEndExamModal}
      <div class="modal-backdrop" transition:fade>
        <div class="modal" transition:slide={{ duration: 300 }}>
          ...
          {#if selectedExam}
            <p>Are you sure you want to end the exam <strong>{selectedExam.name}</strong>?</p>
            <p>This will mark the exam as completed and allow you to enter results.</p>
          {/if}
          
          <div class="modal-actions">
            <button class="cancel-btn" on:click={() => showEndExamModal = false}>Cancel</button>
    ...
    {#if showResultModal}
      <div class="modal-backdrop" transition:fade>
        <div class="modal" transition:slide={{ duration: 300 }}>
          <h2>{getStudentResult(selectedStudent, selectedExam.id) ? 'Edit' : 'Add'} Result</h2>
          
          {#if selectedStudent && selectedExam}
            <div class="result-header">
              <div class="student-info-modal">
                <img src={selectedStudent.avatar || "/placeholder.svg"} alt={selectedStudent.name} class="student-avatar" />
                <div>
                  <p class="student-name">{selectedStudent.name}</p>
                  <p class="student-roll">Roll No: {selectedStudent.rollNumber}</p>
                </div>
              </div>
            ...
            <div class="form-group">
              ...
              <div class="marks-percentage">
                ...
                <span class="status-pill {newResult.marks >= selectedExam.passingMarks ? 'pass' : 'fail'}">
          ...
          <div class="modal-actions">
            <button class="cancel-btn" on:click={() => showResultModal = false}>Cancel</button>
            <button 
              class="save-btn" 
              on:click={saveResult}
            >
